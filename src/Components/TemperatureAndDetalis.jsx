...
export const TemperatureAndDetalis = ({
  ...
  return (
    <div className="select-none">
      <div
        className={`${checkWeather()}  flex justify-center items-center text-2xl font-bold py-6 max-md:text-lg`}
      >
        {current.condition.text}
      </div>
      <div className="grid grid-cols-3 max-md:grid-cols-1 ">
        <div className="flex justify-center items-center ">
          <img width={150} src={current.condition.icon} alt="currentfor"/>
        </div>
        <div className="flex justify-center items-center font-bold text-white text-4xl max-md:py-10">
          {`${current.temp_c.toFixed()} °`}
        </div>
        <div className="text-white flex justify-center items-center flex-col gap-y-3">
          <div className="flex justify-center items-center">
            <CiTempHigh size={30} />
      ...
      <div className="grid grid-cols-4 max-xl:grid-cols-2   gap-y-4 py-5">
